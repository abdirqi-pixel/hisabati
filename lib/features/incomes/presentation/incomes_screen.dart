        ...
        data: (s) {
          ...
          return ListView(
            ...
            children: [
              ...
              const Text('آخر الإيرادات', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                    ...
                    children: items.map((income) {
                      return Card(
                        child: ListTile(
                          ...
                          subtitle: Text('${income['source'] ?? 'مصدر غير محدد'}\n${income['description'] ?? ''}'),
                          isThreeLine: true,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text('إيراد جديد', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
          ...
          TextField(
            controller: source,
            decoration: const InputDecoration(labelText: 'مصدر الإيراد', prefixIcon: Icon(Icons.source_rounded)),
          ),
          const SizedBox(height: 12),
          TextField(
            controller: description,
            decoration: const InputDecoration(labelText: 'التفاصيل', prefixIcon: Icon(Icons.notes_rounded)),
          ),
          const SizedBox(height: 16),
